...
To illustrate, let's look compare the two implementations on an easy task (or at least, easy for BART): the [Friedman function](https://www.sfu.ca/~ssurjano/fried.html)!
