...
.flexBART_fit <- function(Y_train, tX_cont_train, tX_cat_train, tX_cont_test, tX_cat_test, unif_cuts, cutpoints_list, cat_levels_list, edge_mat_list, graph_split, graph_cut_type, a_cat, b_cat, rc_split, prob_rc, a_rc, b_rc, sparse, a_u, b_u, mu0, tau, lambda, nu, M, nd, burn, thin, save_samples, save_trees, verbose, print_every) {
...
.probit_flexBART_fit <- function(Y_train, tX_cont_train, tX_cat_train, tX_cont_test, tX_cat_test, unif_cuts, cutpoints_list, cat_levels_list, edge_mat_list, graph_split, graph_cut_type, a_cat, b_cat, rc_split, prob_rc, a_rc, b_rc, sparse, a_u, b_u, mu0, tau, M, nd, burn, thin, save_samples, save_trees, verbose, print_every) {
