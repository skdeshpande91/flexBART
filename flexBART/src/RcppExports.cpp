...
// predict_flexBART
Rcpp::NumericMatrix predict_flexBART(Rcpp::List tree_draws, Rcpp::NumericMatrix tX_cont, Rcpp::IntegerMatrix tX_cat, bool verbose, int print_every);
RcppExport SEXP _flexBART_predict_flexBART(SEXP tree_drawsSEXP, SEXP tX_contSEXP, SEXP tX_catSEXP, SEXP verboseSEXP, SEXP print_everySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type mu0(mu0SEXP);
    Rcpp::traits::input_parameter< double >::type tau(tauSEXP);
    rcpp_result_gen = Rcpp::wrap(drawTree(tX_cont, tX_cat, unif_cuts, cutpoints_list, cat_levels_list, edge_mat_list, graph_split, graph_cut_type, perc_rounds, perc_threshold, rc_split, prob_rc, a_rc, b_rc, alpha, beta, mu0, tau));
    return rcpp_result_gen;
END_RCPP
}
// drawEnsemble
