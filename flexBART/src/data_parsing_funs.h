...
void parse_nesting(std::vector<hi_lo_map> &nesting, std::vector<edge_map> &nest_graph_in,
                   std::vector<edge_map> &nest_graph_out,std::vector<std::map<int, std::set<int>>> &nest_graph_components,
                   int &p_cont, Rcpp::IntegerMatrix &cov_ensm, std::vector<std::set<int>> &cat_levels,
