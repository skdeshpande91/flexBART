---
title: "Fitting varying coefficient models with flexBART"
---
...
$$
where each function $\beta_{r}(X)$ is approximated with an ensemble of regression trees.
...
## Identified example
We first demonstrate **flexBART**'s functionality using data generated from the model $Y = \beta_{0}(X) + \beta_{1}(X)Z_{1} + \beta_{2}(X)Z_{2} + \sigma\epsilon$ where 
